...
void testJumble() {
	...
	// Unit test to test the exceptions of the class
	cout << "\nTesting exceptions:" << endl;
	cout << "Should throw error below:" << endl;
	try {
		JumblePuzzle test1("T3ST", "med");
	}
	catch (const BadJumbleException& e) {
		cerr << e.what();
		cout << "\nTest Success." << endl << endl;
	}

	// Unit test to test the accessors of the class
	cout << "Testing accessors:" << endl;
	JumblePuzzle test2("TEST", "medium");
	showJumble(test2.getJumble(), test2.getSize());
	cout << "The below values should match where the hidden word is in the puzzle:" << endl << endl;
	cout << "Direction: " << test2.getDirection() << endl;
	cout << "Row number: " << test2.getRowPos() << endl;
	cout << "Column number: " << test2.getColPos() << endl;
	cout << "Puzzle size should be 12: " << test2.getSize() << endl;
