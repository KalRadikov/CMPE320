...
""));
        QIcon icon1;
        icon1.addFile(QStringLiteral("Sprites/torpedo.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon1.addFile(QStringLiteral("Sprites/torpedo.png"), QSize(), QIcon::Normal, QIcon::On);
        specialMissileButton->setIcon(icon1);
...
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        defaultMissileButton->setText(QApplication::translate("MainWindow", "Default Missile", Q_NULLPTR));
